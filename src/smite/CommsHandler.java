...
public class CommsHandler {
    ...
    // Chunk schema:
    int OUR_ARCHON_BITS = 13;
    int ENEMY_ARCHON_BITS = 13;
    int MAP_SYMMETRY_BITS = 2;
    int[] CHUNK_SIZES = {
    ...
    public int readChunk(int chunkIndex) throws GameActionException { // Implements lazy reading from the main shared array
    ...
    boolean write(int value, int startBit, int numBits) throws GameActionException {
    ...
    int read(int beginBit, int numBits) throws GameActionException {
    ...
    public int bitmask(int start, int end, boolean read) {
    ...
    public int whichBit(int index, int bitloc) {
